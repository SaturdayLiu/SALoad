...
#import "SALFrameHandler.h"
#import "SALConditionHandler.h"
#import "SALContentHandler.h"

@interface LoadController()

@property (nonatomic, weak) UIScrollView *loadScrollView;

@property (nonatomic, strong) SALFrameHandler *frameHandler;
@property (nonatomic, strong) SALConditionHandler *conditionHandler;
@property (nonatomic, strong) SALContentHandler *contentHandler;
...
-(instancetype)initWithScrollView:(UIScrollView *)scrollView{
    ...
    if (self) {
        ...
        self.frameHandler = [[SALFrameHandler alloc] initWithLoadController:self];
        self.conditionHandler = [[SALConditionHandler alloc] initWithLoadController:self];
        self.contentHandler = [[SALContentHandler alloc] initWithLoadController:self];
    }
    return self;
}
